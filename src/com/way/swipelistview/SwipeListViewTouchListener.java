...
import com.example.restswipelistview.LogUtils2;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	...
	public SwipeListViewTouchListener(SwipeListView swipeListView,
		...
		LogUtils2.e("*****SwipeListViewTouchListener*******=="+swipeFrontView);
	...
	private void setFrontView(View frontView) {
		LogUtils2.e("********setFrontView==="+frontView);
		...
		case MotionEvent.ACTION_DOWN: {
			...
			for (int i = 0; i < childCount; i++) {
				...
				if (rect.contains(x, y)
					...
					setParentView(child);
					LogUtils2.e("setFrontView(child.findViewById(swipeFrontView))");
					LogUtils2.e("child == "+child);
					LogUtils2.e("child.getId() == "+child.getId());
